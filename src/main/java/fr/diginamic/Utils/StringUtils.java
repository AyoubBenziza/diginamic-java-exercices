...
public final class StringUtils {
     ...
     * @return String
     * @throws IllegalStateException dans le cas où le paramètre objets a une taille nulle
     */
    public static String toString(String separateur, Object... objets) throws IllegalStateException {

        if (objets.length == 0) {
            throw new IllegalStateException("Vous devez concaténer au moins 1 information.");
        }
